...
import { isTouchDevice, isSafari, hasScrollbarGutter, dragThreshold } from "../core/util/browser.js";
...
const UI = {
  ...
  connect(event, password) {
    ...
    const path = document.getElementById("noVNC_setting_path").value;
